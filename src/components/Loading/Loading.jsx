...
export default function Loading() {
  ...
  return (
    <>
      <PageMetadata title='Loading' description='Loading...' keywords='online grocery, fresh vegetables, dairy products, food delivery, online shopping' author='Fresh-Cart Team'></PageMetadata>
